...
Le site contient un accueil responsive, des pages dédiées à la musculation, à la force athlétique et à la lutte, et une page d’erreur 404. L’accueil résume les activités et propose la localisation et un guide d’inscription MonClub commun. Les informations pratiques détaillées sont rattachées à leur discipline. Les informations validées, celles qui restent à confirmer et l’inventaire des médias sont centralisés dans [`docs/CLUB.md`](docs/CLUB.md).
