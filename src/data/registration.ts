...
export const registrationSteps = [
  ...
  { kind: 'formula', title: 'Choisis la force athlétique', description: 'Sélectionne l’activité « Force athlétique », puis la formule qui correspond à ta pratique. Les tarifs sont indiqués dans l’application.' },
