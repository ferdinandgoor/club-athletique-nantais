    ...
    <article className="discipline">
      ...
      <section className="discipline__section" aria-labelledby="practice-title">
        ...
        <div className="discipline__details">
          {discipline.details.map((detail, index) => <div key={detail.title}><span className="discipline__eyebrow">0{index + 1}</span><h3>{detail.title}</h3><p>{detail.text}</p></div>)}
        </div>
      </section>
      <section className="discipline__section discipline__practical" id="infos" aria-labelledby="practice-info-title">
      ...
      <section className="discipline__section discipline__join" aria-labelledby="join-title">
