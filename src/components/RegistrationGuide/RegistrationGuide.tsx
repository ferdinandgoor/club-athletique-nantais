        ...
        {registrationSteps.map((step, index) => (
          <li className="registration-guide__step" key={step.title}>
            <div className="registration-guide__screen" aria-hidden="true">
              ...
              {step.kind === 'formula' && <><span className="registration-guide__pill">✓ Force athlétique</span><strong>Choisis ta formule</strong><span className="registration-guide__choice">Ta pratique<br /><small>Ta formule d’adhésion</small></span><span className="registration-guide__mock-button">Continuer →</span></>}
